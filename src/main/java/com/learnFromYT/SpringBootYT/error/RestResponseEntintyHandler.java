package com.learnFromYT.SpringBootYT.error;

import com.learnFromYT.SpringBootYT.entity.ErrorMessage;
...
@ControllerAdvice
@ResponseStatus
public class RestResponseEntintyHandler extends ResponseEntityExceptionHandler {
